...
// DeprecatedPrependStack overwrites the stack of the current error with the stack
...
// with the received error. Using DeprecatedPrependStack the desired error type can
...
// legacy situations.
func DeprecatedPrependStack(dst, src error) error {
	...
	dstMasked.Stack = append(srcMasked.Stack, dstMasked.Stack...)
